...
def set_packer_options(anim_change_index, output_file_name, packer_to_setup, args):
    ...
    if args.color_aberration_mode:
        ...
        if args.color_aberration_colors:
            packer_to_setup.COLOR_ABERRATION_COLORS = utils.read_color_palette(
                args.color_aberration_colors
            )
        if args.color_aberration_scroll:
            packer_to_setup.COLOR_ABERRATION_SCROLL = utils.read_color_palette(
                args.color_aberration_scroll
            )
